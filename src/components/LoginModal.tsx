          ...
          {clicked ? (
            <>
              ...
              <p className="leading-4">
                ...
                suited backend has been used here. Please use <b>demouser</b> as
                username & <b>demo123</b> as password. You can find these
              ...
              <form onSubmit={submitForm} className="flex flex-col space-y-3">
                <div className="relative">
                  <input
                    ...
                    type="text"
                    placeholder="Your username here... (demouser)"
                ...
                <div className="relative">
                  <input
                    ...
                    type="password"
                    placeholder="Your password here... (demo123)"
                    className="border w-full border-black py-2 px-8 rounded dark:bg-slate-600"
                  />
